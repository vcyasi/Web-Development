...
** Author:       Vincent Yasi 
** Date:         5-28-2019 
** Description:  The class declaration for the GuardianHall child class.
************************************************************************************/ 

#ifndef GUARDIANHALL_H
#define GUARDIANHALL_H

#include "Space.hpp"
#include "Player.hpp"
#include "Dungeon.hpp"

class GuardianHall:public Space
{
private:
	Player *player;
	Dungeon *crypt;
...
public:
	...
	**********************/
	...
	//if player passed
	GuardianHall(Player *inPtr, Dungeon *inDun);
