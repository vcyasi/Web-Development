...
** Author:       Vincent Yasi 
** Date:         5-28-2019 
** Description:  The class declaration for the BoomerangRoom child class.
************************************************************************************/ 

#ifndef BOOMERANGROOM_H
#define BOOMERANGROOM_H

#include "Space.hpp"
#include "Player.hpp"

class BoomerangRoom:public Space
{
private:
	//stores if chest opened or not
	bool chestFlag;
...
public:
	...
	**********************/
	...
	//if player pointer passed
	BoomerangRoom(Player *inPtr);
